...
async function addOrder(o) {
  ...
  let seq = 1;
  try {
    seq = await cmd(["INCR", "seq:" + ds]);
    await cmd(["EXPIRE", "seq:" + ds, "259200"]); // ينتهي بعد 3 أيام
  } catch (_) {}
...
module.exports = { cmd, addOrder, listOrders, setOrderStatus, addReservation, listReservations };
