...
function applyI18nFix(data){
  const rep={cats:[],fromDesc:[],fromQonsole:[],fixedExisting:[],alreadyOk:0,stillMissing:[],descTranslated:[],descMissing:[],catMissing:[]};
...
const I18N_FIX_V = 4; // زوّد الرقم مع أي تحسين للقاموس عشان يتطبق تلقائياً
module.exports={norm,latinOnly,fixEn,PMAP,CMAP,DESC_TR,applyI18nFix,I18N_FIX_V};
